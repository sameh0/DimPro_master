...
public class CircleCountDownView extends FrameLayout {
    ...
    public void onTick(com.project.andredantas.thefinalcountdownproject.widget.CircleCountDownView countDownView){
        ...
        if (progress == endTime - 1) {
            ...
            com.project.andredantas.thefinalcountdownproject.widget.ProgressBarAnimation anim = new com.project.andredantas.thefinalcountdownproject.widget.ProgressBarAnimation(countDownView, endTime, 1);
