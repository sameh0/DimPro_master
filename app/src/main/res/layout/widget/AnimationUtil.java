...
public class AnimationUtil {
    ...
    public static com.project.andredantas.thefinalcountdownproject.widget.AnimationUtil with(View view) {
        return new com.project.andredantas.thefinalcountdownproject.widget.AnimationUtil(view);
    }

    public com.project.andredantas.thefinalcountdownproject.widget.AnimationUtil context(Context context) {
        mContext = context;
        return this;
    }

    public com.project.andredantas.thefinalcountdownproject.widget.AnimationUtil duration(int duration) {
        mDuration = duration;
        return this;
    }

    public com.project.andredantas.thefinalcountdownproject.widget.AnimationUtil animation(int animationId) {
        switch (animationId) {
            case FADE_IN:
    ...
    public com.project.andredantas.thefinalcountdownproject.widget.AnimationUtil visibility(int visibility) {
